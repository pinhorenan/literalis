  ...
  return (
    <div className="absolute top-4 right-6 flex items-center gap-2 z-20">
      ...
      <Link href="/signin">
        <Button
          variant="ghost"
          className="text-sm hover:underline text-[var(--text-primary)]"
        >
          Entrar
        </Button>
      </Link>
...
function LandingHero() {
  return (
    <div className="max-w-xl space-y-6 text-left relative z-10 pb-2">
      ...
      <motion.h1
        className="text-4xl font-bold tracking-tight sm:text-5xl leading-tight text-[var(--text-primary)]"
      ...
      >
        ...
        <div className="relative inline-block">
          <motion.span
            ...
            className={clsx(
              'relative z-10',
              'bg-[linear-gradient(120deg,var(--surface-alt)_0%,var(--surface-alt)_100%)]',
              'bg-no-repeat bg-left-bottom bg-[length:0%_0.25rem]'
            )}
          >
      ...
      <motion.p
        className="text-[var(--text-secondary)] text-lg max-w-prose"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <Link href="/signup">
          <Button
            ...
            className={clsx(
              ...
              'text-[var(--text-primary)] shadow-lg border-2 border-[var(--border-subtle)]',
